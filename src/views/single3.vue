<template>
  <div>
    ...
    <div style="display: flex;">
      <section class="video_content grid">
        <div class="video_items" v-for="(item, index) in videoItems" :key="index">
          <video controls>
            <source
              src="https://firebasestorage.googleapis.com/v0/b/videoverse-61929.appspot.com/o/video3.mp4?alt=media&token=dbf85d0d-379a-42df-92b7-8e4be86d5c70"
              type="video/mp4">
          </video>
    ...
    <div class="details_Comment">
      ...
      <div class="heading">Comments 99+</div> <hr>
